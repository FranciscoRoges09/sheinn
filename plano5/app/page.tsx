      ...
      <div className="min-h-screen flex items-center justify-center bg-white px-4">
        <div className="text-center max-w-lg">
          <div className="flex justify-center mb-6">
            <Image src="/shein-logo.png" alt="SHEIN" width={150} height={45} className="object-contain" />
          </div>
          ...
          {error.includes("API key") && (
            <div className="bg-gray-50 border-2 border-gray-200 rounded-lg p-6 text-left">
              <p className="text-sm font-bold text-gray-900 mb-3">Como configurar a API key na Vercel:</p>
              <ol className="text-sm text-gray-700 space-y-2 list-decimal list-inside">
                <li>Acesse seu projeto no dashboard da Vercel</li>
                <li>
                  Vá em <strong>Settings → Environment Variables</strong>
                </li>
                <li>
                  Adicione uma nova variável:
                  <div className="bg-white border border-gray-300 rounded px-3 py-2 mt-2 font-mono text-xs">
                    <div>
                      <strong>Name:</strong> BUCKPAY_API_KEY
                    </div>
                    <div>
                      <strong>Value:</strong> sua_chave_aqui
                    </div>
                  </div>
                </li>
                <li>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <p className="text-xs text-gray-600">
                  Não tem uma chave da API? Entre em contato com o suporte da BuckPay para obter suas credenciais.
                </p>
              </div>
            </div>
          )}
